...
module.exports.handleEvent = async function ({ api, event, Users }) {
 ...
 const replies = [
      ...
      "☆𝗞𝗶 𝗿𝗲𝗲 𝗩𝗮𝗶 𝗮𝘁𝗼𝗼 𝗕𝗯𝘆 𝗯𝗯𝘆 𝗞𝗼𝗿𝗲𝗻 𝗸𝗻𝗼__ ☹️",
      "আমার মিষ্টি কে দেখছো 🥺? খুঁজে পাচ্ছি না...!! 😩🫶🏻",
      "আমার বস পাখির 🕊️ পক্ষ থেকে তোমারে এতো এতো ভালোবাসা-🥰😽🫶",
      "☆𝗞𝗶 𝗿𝗲𝗲 𝗩𝗮𝗶 𝗮𝘁𝗼𝗼 𝗕𝗯𝘆 𝗯𝗯𝘆 𝗞𝗼𝗿𝗲𝗻 𝗸𝗻𝗼__ ☹️",
      ".__𝐚𝐦𝐤𝐞 𝐬𝐞𝐫𝐞 𝐝𝐞𝐰 𝐚𝐦𝐢 𝐌𝐢𝐬𝐭𝐲'𝐫 𝐤𝐚𝐬𝐞 𝐣𝐚𝐛𝐨!!🥺.....😗",
      "𝐎𝐢 𝐗𝐚𝐧 😗 𝐏𝐚𝐚𝐤𝐡𝐢 𝐢𝐬 𝐇𝐞𝐫𝐞 💫",
      "‎এতো ডেকো না,প্রেম এ পরে যাবো তো 🤐🙈",
      "𝗛𝗲𝘆 𝗕𝗯𝘆💫 𝗜'𝗺 𝗣𝗮𝗸𝗵𝗶 𝗕𝗯𝘇 😛",
      "•⎯͢⎯⃝𝗞ʌ𝗛 𝗮ɴɩ 𝘀𝗨 ɴ𝗼 𝘇𝗨 𝗯𝗮ɴɩ 𝘀ʋ𝗡𝗢 𝗺ʋ'𝗝ʜə' 𝗽ə𝗬𝗮'ɽ 𝗵ʋ𝗔 ʈh𝗔 ɩ𝗞'ɽ𝗮𝗥 𝗵ʋ𝗔 ʈ𝗵'𝗮 <!! () 🙃",
