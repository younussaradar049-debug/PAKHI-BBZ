...
if (!fs.existsSync(process.cwd() + '/Maria_Database')) {
    fs.mkdirSync(process.cwd() + '/Maria_Database');
    fs.writeFileSync(process.cwd() + '/Maria_Database/A_README.md', 'This folder is used by ChernobyL(NANI =)) ) to store data. Do not delete this folder or any of the files in it.', 'utf8');
}
var db = new BetterDB(process.cwd() + "/Maria_Database/SyntheticDatabase.sqlite");
